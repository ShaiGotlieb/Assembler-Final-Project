...
/* get a word each time (by splitLines structures) and get index to decide which adress to return*/
...
/* Function to convert a given decimal number to binary number*/
